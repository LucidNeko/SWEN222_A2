...
import wolf3d.Wolf3DNetworkingDemo;
 ...
 *
 */
public class WolfFrameNetworkingDemo extends JFrame implements MouseListener{
	...
	public WolfFrameNetworkingDemo(String ip, int port){
		/*Basic frame setup*/
		f = new JFrame();
