...
public class MapBuilderV2 extends JFrame implements ActionListener {
	...
	private void actionNew() {
		mapWidth = Integer.parseInt(JOptionPane.showInputDialog(MapBuilderV2.this, "Enter the width:"));
		mapHeight = Integer.parseInt(JOptionPane.showInputDialog(MapBuilderV2.this, "Enter the height:"));
	...
	private void actionLoad() {
		JFileChooser jfc = new JFileChooser(new File(MapBuilderV2.class.getResource("/wolf3d/assets").getPath()));
