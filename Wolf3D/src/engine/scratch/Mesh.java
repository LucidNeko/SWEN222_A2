...
public class Mesh {
	...
	public Mesh(Vec3[] vertices, Vec2[] uvs, int[] triangles) {
		...
		if(uvs != null && uvs.length != vertices.length)
			throw new IllegalArgumentException("If uvs is not null, then it must provide a uv coordinate for each vertex.");
	...
	private void createBuffers() {
		...
		uvBuffer 	 = Buffers.newDirectFloatBuffer(triangles.length*2);
